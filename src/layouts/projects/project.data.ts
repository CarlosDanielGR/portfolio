...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    redirects: [
      {
        icon: "web",
        url: "https://affiliates.inlaze.com/en",
      },
    ],
  },
  {
    ...
    redirects: [
      {
        icon: "git",
        url: "https://github.com/CarlosDanielGR/learn-nest",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    redirects: [
      {
        icon: "git",
        url: "https://github.com/CarlosDanielGR/Angular-ngrx",
      },
    ],
  },
  {
    ...
    redirects: [
      {
        icon: "git",
        url: "https://github.com/CarlosDanielGR/archetype",
      },
    ],
  },
  {
    ...
    redirects: [
      {
        icon: "web",
        url: "https://bet.inlaze.com/br/bookmakers",
      },
    ],
  },
  {
    ...
    redirects: [
      {
        icon: "git",
        url: "https://github.com/CarlosDanielGR/learn-react",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    redirects: [
      {
        icon: "web",
        url: "https://elena.actus.io/",
      },
      {
        icon: "git",
        url: "https://github.com/carlosdanielgr/actus",
      },
    ],
  },
  {
    ...
    redirects: [
      {
        icon: "web",
        url: "https://resuelvetuseguro.mx/",
      },
      {
        icon: "git",
        url: "https://github.com/carlosdanielgr/resolve-insurance",
      },
    ],
  },
  {
    ...
    redirects: [
      {
        icon: "web",
        url: "https://nomadasmedia.com/",
      },
      {
        icon: "git",
        url: "https://github.com/carlosdanielgr/nomadas-media",
      },
    ],
  },
];
